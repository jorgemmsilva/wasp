...
require (
	...
	github.com/iotaledger/hive.go/core v1.0.0-rc.3.0.20231110115447-7605386261d2 // indirect
	github.com/iotaledger/hive.go/stringify v0.0.0-20231110115447-7605386261d2 // indirect
