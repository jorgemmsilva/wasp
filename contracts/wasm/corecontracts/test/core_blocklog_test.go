...
func TestGetBlockInfo(t *testing.T) {
	...
	for i := uint32(0); i < 5; i++ {
		...
		require.Equal(t, expectBlockInfo.PreviousChainOutputs, blockinfo.PreviousChainOutputs)
...
func TestIsRequestProcessed(t *testing.T) {
	...
	notExistReqID := wasmtypes.RequestIDFromString("0xcc025a91fe7f071a7a53a1db5257d161d666d4aa1606422a3b3553c2b8b904e7010000000000")
